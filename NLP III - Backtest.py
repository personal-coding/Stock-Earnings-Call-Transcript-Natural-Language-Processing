...
df = pd.read_csv('./net_topic_postive_score_final.txt', sep='\t')
df.date = pd.to_datetime(df.date)
df = df.sort_values('date')

topic_name = 'revenue_net'

df['revenue_net'] = df.rev_positive_sentence_score - df.rev_negative_sentence_score
#df['earnings_net'] = df.earnings_positive_sentence_score - df.earnings_negative_sentence_score
